            ...
            <div class="w-full flex gap-2">
                <div class="w-[60%] shadow-xl bg-[#f5f5f5] rounded-xl p-4">
                    ...
                    <div class="w-[40%] py-10 block mx-auto">
                        <div>
                            <p class="text-center text-5xl font-bold mb-2 text-main">&#8369;{{((($shift->closing_cash + $shift->cash_in) - $cashOutPayments) - $shift->cash_out) + ($cashInCharge + $cashOutCharge) - $cashOutPayments}}.00</p>
