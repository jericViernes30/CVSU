...
<body class="w-full h-screen bg-[#fefefe]">
    ...
    <div class="w-full h-[93%] flex z-0">
        <div class="w-[5%] pt-10">
            ...
            <a href="{{route('office.dashboard')}}" class="w-full flex items-center justify-center h-auto py-4">
                ...
                <form action="{{route('office.add_item')}}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" bg-white rounded-md p-10 mb-5">
                        ...
                        <div class="w-full mb-10">
                            ...
                            <textarea name="description" id=""rows="2" class="w-full mt-1 p-2 border border-[#eaeaea] focus:border-main outline-none rounded-md"></textarea>
                        </div>
                        <div class="w-full flex items-center justify-between gap-5">
                            <div class="w-1/2">
                                <label for="" class="text-gray-500">SKU</label>
                                <input type="text" name="item_sku" class="w-full mt-1 px-2 py-1 outline-none border-b-2 bg-slate-50 border-[#eaeaea] focus:border-b-2 focus:border-main">
                            </div>
                            <div class="w-1/2">
                                <label for="" class="text-gray-500">QR Value</label>
                                <input type="text" name="item_qr" class="w-full mt-1 px-2 py-1 outline-none border-b-2 bg-slate-50 border-[#eaeaea] focus:border-b-2 focus:border-main" autofocus="false">
                            </div>
                        </div>
                    </div>
                    <div class=" bg-white rounded-md p-10">
                        <div class="w-full flex items-center justify-between gap-16 mb-10">
                            <div class="w-1/2">
                                ...
                                <input type="number" name="cost" class="w-full mt-1 px-2 py-1 outline-none border-b-2 bg-slate-50 border-[#eaeaea] focus:border-b-2 focus:border-main">
                            </div>
                            <div class="w-1/2">
                        ...
                        <div class="w-ful flex gap-16">
                            ...
                            <div class="w-1/2 flex gap-5 items-center justify-end">
                                <button class="w-[100px] bg-slate-50 uppercase rounded-sm py-2 shadow-md font-medium text-xs">Cancel</button>
