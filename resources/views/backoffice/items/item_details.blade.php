                    ...
                    <div class=" bg-white rounded-md p-10 mb-5">
                        ...
                        <div class="w-full flex items-center justify-between gap-5">
                            ...
                            <div class="w-1/2">
                                ...
                                <input type="text" name="barcode" value="{{$item->barcode}}" class="w-full mt-1 px-2 py-1 outline-none border-b-2 bg-slate-50 border-[#eaeaea] focus:border-b-2 focus:border-main" autofocus="false">
                            </div>
                        </div>
                    </div>
                    <div class=" bg-white rounded-md p-10">
                        ...
                        <div class="w-ful flex gap-16">
                            <div class="w-full flex gap-5 items-center justify-end">
                                <button class="w-[100px] bg-main rounded-sm py-2 shadow-md font-medium text-white">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
