...
<body class="w-full h-screen bg-[#fefefe]">
    ...
    <div id="body" class="w-full h-[93%] flex z-0">
        <div class="w-[5%] pt-10 bg-[#fefefe]">
            ...
            <div class="w-full relative">
                <a href="{{route('office.ordering')}}" class="w-full flex items-center justify-center h-auto py-4 bg-[#f5a7a4]">
        ...
        <div id="main" class="w-[95%] bg-[#f2f2f2] grid grid-cols-2 gap-6 grid-rows-2 p-7">
            <div class="w-full bg-white rounded-xl py-3 px-5">
                ...
                <div class="pt-2">
                    <input id="item_search" type="search" name="item_name" placeholder="Search for item name" autocomplete="off" class="w-full px-5 py-2 rounded-lg outline-none border border-[#565857] focus:border-main">
                    <p>Result:</p>
                    ...
                    <div class="w-full flex py-2">
                        ...
                        <div class="w-[30%] flex flex-col gap-2">
                            ...
                            <input id="quantity" type="number" name="quantity" class="w-full px-5 py-2 border-b border-[#565857] outline-none focus:border-main">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full bg-white rounded-xl py-3 px-5">
                ...
                <div class="pt-2 mb-4">
                    <input id="supplier_search" autocomplete="off" type="search" name="supplier_name" placeholder="Search for supplier name" class="w-full px-5 py-2 rounded-lg outline-none border border-[#565857] focus:border-main">
                    <p>Result:</p>
