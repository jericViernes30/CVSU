                ...
                <div class="w-full h-full flex">
                    <div class="w-1/2 flex flex-col items-center h-full bg-[#f8f8f8] border-r border-bd">
                        ...
                        <div class="w-full flex flex-col items-center h-1/2 overflow-y-scroll border-b border-bd">
                            ...
                            $foodPrices = [
                                'Baked Macaroni' => 25, // Example price for food_name_1
                                'Palabok' => 25,
                                'Sopas' => 20,
                                'Spaghetti' => 20, // Example price for food_name_2
                            ...
                            <form action="{{route('sale')}}" method="POST">
                                ...
                                <div class="w-full flex item border border-bd px-2 relative rounded-xl mb-3">
                                    ...
                                    <div class="w-full flex justify-end items-center">
                                        <p class="text-xl">&#8369;</p>
                                        <input id="cash" type="number" name="cash" value="00" class="px-1 py-2 outline-none text-xl appearance-none">
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="w-full bg-proceed py-2 rounded-xl text-lg text-white mb-10">Cash</button>
